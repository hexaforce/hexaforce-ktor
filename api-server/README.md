# io.hexaforce - Kotlin Server library for Swagger Petstore
...
The server builds as a fat jar with a main entrypoint. To start the service, run `java -jar ./build/libs/api-server.jar`.
